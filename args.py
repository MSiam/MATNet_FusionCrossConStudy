...
def get_parser():
    ...
    parser.add_argument('-ckpt_path', type=str, default='ckpts/two_stream_frame_5_sample_3')
    parser.add_argument('-ckpt_epoch', type=int, default=23)

    parser.add_argument('-frame_nb', type=int, default=5)
    parser.add_argument('-sampling_rate', type=int, default=3)

    parser.add_argument('-center', dest='center', action='store_true')
    parser.add_argument('-cfg_file', default='configs/two_stream/r101_frame_5_sample_3.yaml', type=str)

    parser.add_argument('-result_dir', type=str, default='two_stream_frame_5_sample_3/masks')

    parser.add_argument('-wandb_user', type=str, default='yvv')
    parser.add_argument('-wandb_project', type=str, default='MATNet_MOCA')
